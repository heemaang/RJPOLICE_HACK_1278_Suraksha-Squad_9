          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white p-6 rounded-md shadow-md">
              ...
              <p>
                ...
                {props.barAssociationNumber}
              </p>
              <p>
                <strong>Legal Specialization:</strong>{" "}
                {props.legalSpecialization}
              </p>
              <p>
                <strong>Years of Practice:</strong> {props.yearsOfPractice}
              </p>
              <p>
                <strong>Law School Attended:</strong> {props.lawSchoolAttended}
              </p>
              <p>
                <strong>Professional Certifications:</strong>{" "}
                {props.professionalCertifications}
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-md shadow-md">
              ...
              <p>
                <strong>Law Firm:</strong> {props.lawFirm}
              </p>
              <p>
                <strong>Office Address:</strong> {props.officeAddress}
              </p>
              <p>
                <strong>Contact Number:</strong> {props.contactNumber}
              </p>
              <p>
                <strong>Areas of Practice:</strong> {props.areasOfPractice}
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="container mx-auto mb-2 p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-white p-6 rounded-md shadow-md">
              ...
              <p>
                <a
                  href={props.lawFirmWebsite}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  {props.lawFirmWebsite}
                </a>
              </p>
            </div>
          </div>
