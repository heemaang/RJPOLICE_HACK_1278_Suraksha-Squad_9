...
function Footer() {
  return (
    <div>
      <footer className='bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-700 via-blue-800 to-gray-900 rounded-t-md mt-12'>
	<div className="container flex flex-col p-4 text-white text-md font-medium mx-auto md:p-8 lg:flex-row dark:divide-gray-400">
    ...
    <div className='flex justify-center text-white text-lg font-medium h-20'>
        Made with ❤️ by Suraksha Squad
    </div>
</footer>
    </div>
  )
