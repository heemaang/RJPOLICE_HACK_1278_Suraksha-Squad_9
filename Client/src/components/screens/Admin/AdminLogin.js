...
const API_URL = "http://localhost:5000/api/admin/loginad"; // Update with your actual admin login endpoint
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        // Redirect to the admin dashboard or any other page after successful login
        navigate('/AdminDash');
      } else {
