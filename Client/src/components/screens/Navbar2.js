    ...
    <div>
      ...
      <div className="flex items-center justify-between py-4">
        ...
        <div className="hidden sm:flex sm:items-center">
          <button onClick={toggleRegisterDropdown} className="font-semibold hover:bg-white border px-12 py-2 rounded-lg hover:text-blue-900">MY PROFILE</button>
          <div
              className={`${
                isRegisterDropdownOpen ? 'block' : 'hidden'
              } absolute bg-white rounded shadow-md mt-32 w-44 ml-5 text-blue-900 font-medium`}
            >
