    ...
    <div className='grid grid-cols-2 gap-4'>
      <div className='ml-[147px]'>
        ...
        <div className='grid grid-cols-2 gap-2'>
          <div><button className='py-3 mt-5 rounded-md w-full border bg-white text-blue-900 font-semibold text-lg'>File a Complaint</button></div>
          <div><button className='py-3 mt-5 rounded-md w-full border text-blue-900 bg-white font-semibold text-lg'>Connect via Whatsapp</button></div>
        </div>
      </div>
